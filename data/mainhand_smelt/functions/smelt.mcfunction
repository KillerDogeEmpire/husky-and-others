...
item modify entity @s weapon.mainhand mainhand_smelt:consume
item modify block ~ 0 ~ container.0 mainhand_smelt:limit
item modify block ~ 0 ~ container.0 mainhand_smelt:smelt
